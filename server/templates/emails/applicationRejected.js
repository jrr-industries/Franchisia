export default function applicationRejectedEmail(application) {
...
<body>
  <div class="wrapper">
    <div class="card">
      ...
      <p>Regarding your application for <strong>${application.listing?.title || 'the franchise'}</strong>.</p>
      <p>After careful review, we regret to inform you that your application has been rejected.</p>
      <div class="info">
      ...
      <p>Don't be discouraged — there are many other franchise opportunities available. Browse our marketplace to find the perfect fit for you.</p>
      <div class="btn-wrap">
        <a href="${process.env.APP_URL || 'http://localhost:5173'}/marketplace" class="btn">Browse Opportunities</a>
      </div>
      <div class="footer">
