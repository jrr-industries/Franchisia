...
import {
  ...
  SmilePlus, X, Paperclip, Image as ImageIcon,
} from 'lucide-react';
          ...
          {convLoading ? (
            ...
            <div style={{ padding: 40, textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 13, color: 'var(--text-muted)', marginTop: 4 }}>
                {searchQuery ? 'Try a different search term' : 'Start a conversation from a profile page'}
              </p>
            </div>
          ) : (
            filteredConvs.map((c) => {
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <span style={{ fontSize: 14, fontWeight: unread ? 600 : 400 }}>{displayName}</span>
        ...
        {activeConvData ? (
          <>
            <div style={{
              ...
              />
              <div style={{ flex: 1 }}>
                <span style={{ fontSize: 14, fontWeight: 600 }}>{otherParticipant?.name || activeConvData.subject || 'Unknown'}</span>
                          ...
                          >
                            ...
                            <div style={{
                              ...
                              <div style={{
                                ...
                                <p style={{ fontSize: 14, lineHeight: 1.5 }}>{m.isDeleted ? 'Message deleted' : m.content}</p>
                              </div>
                              <span style={{
                                fontSize: 11,
              ...
              <div style={{ display: 'flex', gap: 10, alignItems: 'flex-end' }}>
                <div style={{ position: 'relative', flex: 1 }}>
                  <div style={{ display: 'flex', gap: 4, alignItems: 'flex-end' }}>
                    ...
                    <button style={{ ...iconBtnStyle, marginBottom: 2 }} title="Attach file">
                      <Paperclip size={18} />
                    </button>
                    <input
                      value={newMessage}
