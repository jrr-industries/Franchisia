...
const defaultPlans = [
  { name: "Free", slug: "free", price: 0, interval: "month", description: "Perfect for getting started", isPopular: false, features: { "Basic Profile": true, "Browse Franchises": true, "Email Support": true, "Verified Profile": false, "Unlimited Search": false, "Direct Messaging": false, "Priority Support": false, "Unlimited Listings": false, "CRM Tools": false } },
  { name: "Professional", slug: "professional", price: 10, interval: "month", description: "For serious franchise seekers", isPopular: true, features: { "Basic Profile": true, "Browse Franchises": true, "Email Support": true, "Verified Profile": true, "Unlimited Search": true, "Direct Messaging": true, "Priority Support": true, "Unlimited Listings": false, "CRM Tools": false } },
  { name: "Enterprise", slug: "enterprise", price: 25, interval: "month", description: "For franchisors & brokers", isPopular: false, features: { "Basic Profile": true, "Browse Franchises": true, "Email Support": true, "Verified Profile": true, "Unlimited Search": true, "Direct Messaging": true, "Priority Support": true, "Unlimited Listings": true, "CRM Tools": true } },
];
            ...
            {plans.map((plan, index) => (
              ...
              >
                ...
                <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                  ...
                  >
                    {plan.price === 0 ? "Get Started" : plan.isPopular ? "Upgrade" : "Choose Enterprise"} <ArrowRight size={16} />
                  </Button>
                </motion.div>
