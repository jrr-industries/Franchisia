...
export default function AdminCitiesEditor() {
  ...
  const [form, setForm] = useState({
    name: "", state: "", image: "", isFeatured: false, displayOrder: 0,
  });
  ...
  const openCreate = () => {
    setEditing(null);
    setForm({ name: "", state: "", image: "", isFeatured: false, displayOrder: 0 });
    setShowModal(true);
  };
  ...
  const openEdit = (item) => {
    ...
    setForm({
      ...
      isFeatured: item.isFeatured ?? false, displayOrder: item.displayOrder ?? 0,
    });
    setShowModal(true);
  };
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1 }}>
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 13, color: "var(--text-muted)", margin: 0 }}>Order: {item.displayOrder} | Listings: {item.listingCount ?? 0}</p>
                  </div>
                </div>
              ...
              <div style={s.formRow}>
                ...
                <div style={s.halfField}>
                  <div style={s.fieldGroup}>
                    ...
                    <input type="number" style={s.input} value={form.listingCount} disabled />
                  </div>
                </div>
              </div>
