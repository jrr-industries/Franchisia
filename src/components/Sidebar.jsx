...
import { LayoutDashboard, Compass, Building2, MessageSquare, Bell, User, Settings, LogOut, Users, BarChart3, Shield, ShieldCheck, FileText, AlertTriangle, Heart, Search, Briefcase, ClipboardList, Activity, Server, Megaphone, X, FileSignature } from 'lucide-react';
  ...
  const sidebarContent = (
    <>
      ...
      <div style={{ padding: 12, display: 'flex', flexDirection: 'column', gap: 4, flex: 1, overflow: 'auto' }}>
        ...
        <p style={{ fontSize: 11, fontWeight: 600, color: 'var(--on-surface-variant)', textTransform: 'uppercase', letterSpacing: 1, padding: '8px 12px', marginTop: 16, display: collapsed ? 'none' : 'block' }}>Company</p>
        <Link to="/dashboard/policies" style={linkStyle('/dashboard/policies')} title="Policies & Terms">
          <FileSignature size={20} style={{ flexShrink: 0 }} />
          {!collapsed && 'Policies & Terms'}
        </Link>
